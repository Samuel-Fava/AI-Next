      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        ...
        <div className="w-full max-w-4xl gap-4">
          ...
          <div className="w-full flex mt-4 gap-4">
            <div className="bg-gray-800 w-1/3 p-4 rounded-lg">
              <div className="flex items-center justify-between">
                <div className="flex gap-2 items-center text-xl"><Settings /> 73°F
                </div>
                <div className="text-gray-400">Sunny</div>
              </div>

              <div className=" flex text-gray-400 justify-between mt-2"><div>Dallas</div><div>H: 76° L: 37°</div></div>
            </div>
            <div className="bg-gray-800 w-1/3 p-4 rounded-lg flex items-center gap-4">
              ...
              <div>Musk Says X Hit By 'Massive Cyberattack'</div>
            </div>
            <div className="bg-gray-800 w-1/3 p-4 rounded-lg flex items-center gap-4">
              <div className="flex items-center max-w-20 overflow-hidden justify-center rounded-sm"><Image src={avatar_2} alt="avatar" className="max-w-20" /></div>
              <div>Student Cracks Century-Old Math...</div>
            </div>
          </div>
        </div>
      </div>
